...
<main class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="text-center mb-5">
            <h1 class="h3 mb-2 text-gray-800">Kelompok 4</h1>
            <p class="lead text-muted">Orang-orang hebat di balik Website ini.</p>
        </div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 text-center py-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text text-primary-emphasis fw-bold">🔷 S6G 🔷</div>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="https://ibnutugas.free.nf/" class="btn btn-primary btn-sm mx-1" target="blank">Tugas Mandiri</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 text-center py-4">
                    ...
                    <div class="card-footer bg-transparent border-0">
                        <a href="#" class="btn btn-primary btn-sm mx-1" target="blank">Tugas Mandiri</a>
                    </div>
                </div>
            </div>
                        <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 text-center py-4">
                    ...
                    <div class="card-footer bg-transparent border-0">
                        <a href="https://hndetugasmandiripwl.wuaze.com/" target="blank" class="btn btn-primary btn-sm mx-1" target="blank">Tugas Mandiri</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 mb-4">
