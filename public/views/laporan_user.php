                    ...
                    <?php foreach ($daftar_user as $user): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="index.php?page=user_edit&id=<?php echo $user['id_user']; ?>" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <?php if ($_SESSION['id_user'] != $user['id_user']): // Tombol hapus tidak muncul untuk diri sendiri ?>
                                    <a href="index.php?page=user_delete&id=<?php echo $user['id_user']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus user ini?');">
