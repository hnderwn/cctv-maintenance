...
switch ($page) {
    ...
    case 'logout':
        ...
        if ($page === 'login') $c->login();
        elseif ($page === 'proses_login') $c->prosesLogin();
        else $c->logout();
        break;
    ...
    case 'about_us':
        require_once 'public/views/about_us.php';
        break;
    ...
    case 'teknisi_delete':
        ...
        $c = new TeknisiController($conn);
        if ($page === 'teknisi') $c->index();
        elseif ($page === 'teknisi_create') $c->create();
        elseif ($page === 'teknisi_store') $c->store();
        elseif ($page === 'teknisi_edit') $c->edit();
        elseif ($page === 'teknisi_update') $c->update();
        else $c->delete();
        break;

    // Rute 'cctv' diubah menjadi 'cctv_unit'
    case 'cctv_unit':
    case 'cctv_unit_create':
    case 'cctv_unit_store':
    case 'cctv_unit_edit':
    case 'cctv_unit_update':
    case 'cctv_unit_delete':
        require_once 'app/Controllers/CctvUnitController.php';
        $c = new CctvUnitController($conn);
        if ($page === 'cctv_unit') $c->index();
        elseif ($page === 'cctv_unit_create') $c->create();
        elseif ($page === 'cctv_unit_store') $c->store();
        elseif ($page === 'cctv_unit_edit') $c->edit();
        elseif ($page === 'cctv_unit_update') $c->update();
        else $c->delete();
        break;

    // Rute 'cctv_type' diubah menjadi 'cctv_tipe'
    case 'cctv_tipe':
    case 'cctv_tipe_create':
    case 'cctv_tipe_store':
    case 'cctv_tipe_edit':
    case 'cctv_tipe_update':
    case 'cctv_tipe_delete':
        require_once 'app/Controllers/CctvTipeController.php';
        $c = new CctvTipeController($conn);
        if ($page === 'cctv_tipe') $c->index();
        elseif ($page === 'cctv_tipe_create') $c->create();
        elseif ($page === 'cctv_tipe_store') $c->store();
        elseif ($page === 'cctv_tipe_edit') $c->edit();
        elseif ($page === 'cctv_tipe_update') $c->update();
        else $c->delete();
        break;

    // (case untuk komponen tetap sama)
    case 'komponen':
    case 'komponen_create':
    case 'komponen_store':
    case 'komponen_edit':
    case 'komponen_update':
    case 'komponen_delete':
        require_once 'app/Controllers/KomponenController.php';
        $c = new KomponenController($conn);
        if ($page === 'komponen') $c->index();
        elseif ($page === 'komponen_create') $c->create();
        elseif ($page === 'komponen_store') $c->store();
        elseif ($page === 'komponen_edit') $c->edit();
        elseif ($page === 'komponen_update') $c->update();
        else $c->delete();
        break;
    ...
    case 'export_maintenance': // <-- RUTE BARU
    ...
    case 'kerusakan_create':
    case 'kerusakan_store':
    case 'kerusakan_edit':
    case 'kerusakan_update':
    case 'kerusakan_delete':
    case 'export_kerusakan':
    ...
    case 'user_update':
    case 'user_delete':
    case 'user_reset_password': // <-- RUTE BARU
    ...
    case 'api_get_log_details': // Untuk modal detail komponen
        ...
        (new ApiController($conn))->getLogDetails();
        break;
    case 'api_get_log_by_id': // BARU: Untuk mengisi form edit
        require_once 'app/Controllers/ApiController.php';
        (new ApiController($conn))->getLogById();
        break;
